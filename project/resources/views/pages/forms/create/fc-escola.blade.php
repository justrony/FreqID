...
@section('title', 'Nova Escola - FreqID')

@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 p-0">
        <header class="top-header p-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="m-0 text-secondary fw-bold">Cadastro de Nova Escola</h5>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <form action="{{ route('escola.store') }}" method="POST">
                        ...
                        <h6 class="border-bottom pb-2 mb-4" style="color: var(--primary-color)">Informações da Escola</h6>
